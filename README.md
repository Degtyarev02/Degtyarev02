...
- 	✉️ Клиент-серверный мессенджер под андроид [Discussion](https://github.com/Degtyarev02/MessengerProject) || [Ссылка на apk](https://github.com/Degtyarev02/MessengerProject/blob/main/Messenger_Project/app/src/main/res/discussion.apk)
...
-   🚘 Курсовая работа на тему "Сервис по аренде элитных автомобилей" с использованием Spring Framework [DiamondRent](https://github.com/Degtyarev02/CAR_RENT) || [Ссылка на сайт](https://diamondcar.herokuapp.com)
